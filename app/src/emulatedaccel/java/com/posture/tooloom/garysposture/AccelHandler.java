...
//        sensorManager = (SensorManager)mContext.getSystemService(Context.SENSOR_SERVICE);
        ...
        Log.d("Gary:", "Emulated AccelHandler create Object");
...
//        sensorManager.registerListener(this, accel, SensorManager.SENSOR_DELAY_NORMAL);
        ...
        Log.d("Gary:", "Emulated AccelHandler startAccel");
    ...
    public static AccelHandler getInstance(Context mContext,double sampleTime){
            ...
            Log.d("Gary:", "Emulated AccelHandler getInstance");
...
//        singletonAccelHandler = null;
        Log.d("Gary:", "Emulated AccelHandler stopAccel");
    }

    public void pauseAccel(){
        if (started) {
            sensorManager.unregisterListener(this);
            Log.d("Gary:", "Emulated AccelHandler pauseAccel");
        }
    }
...
//            sensorManager.registerListener(this, accel, SensorManager.SENSOR_DELAY_NORMAL);
            sensorManager.registerListener(this, accel, SensorManagerSimulator.SENSOR_DELAY_NORMAL);
            Log.d("Gary:", "Emulated AccelHandler restartAccel");
        }
    }
    ...
    public double getAverageZ (){
        Log.d("Gary:" , "Emulated Number of samples " + zcount);
        double avgZ;
        avgZ = totalZ;
        avgZ /= zcount;
        Log.d("Gary:" , "Emulated totalZ " + totalZ);
        Log.d("Gary:", "Emulated avgZ " + avgZ);
        return avgZ;
        }
    public double getSessionAverageZ(){
        Log.d("Gary:" , "Emulated Average SessionZ " + (getAverageZ() - calibratedZ) );
        Log.d("Gary:", "Emulated sessionTimeTotal " + getSessionTimeTotal());
        Log.d("Gary:", "Emulated Average Sample Time " + getSessionTimeTotal()/zcount);
        Log.d("Gary:", "Emulated Samples Above Forward Threshold " + samplesfwd);
        Log.d("Gary:", "Emulated Samples Below Backward Threshold " + samplesbwd);
    ...
    public void onSensorChanged(SensorEvent event) {
        if (started) {
//            Log.d("Gary:", "Emulated AccelHandler Triggered " + System.currentTimeMillis());
